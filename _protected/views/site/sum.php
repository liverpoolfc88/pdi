        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-2">
                    ...
                    <input class="form btn btn-danger" type="button"
                           onclick=" tableToExcel('resultTable','sum', 'Defekt.xls')" value="Export to Excel">
                </div>
                <?php ActiveForm::end(); ?>
            </div>
        </div>
                ...
                <div style="text-align: -webkit-center;">
                    ...
                    <table id="resultTable" class="customers ">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center"><a>ID</a></th>
                            <th><a class="ahref " href="<?= Url::to(['/site/sum', 'sort' => 'sh_name']) ?>">Tsexlar
                            </th>
                            <!--                                <th>-->
                            ...
                            <th><a class="ahref "
                                   href="<?= Url::to(['/site/sum', 'sort' => 'm.model_name']) ?>">Model
                            </th>


                            <th><a class="ahref " href="<?= Url::to(['/site/sum', 'sort' => 'level1']) ?>">Level
                                    1</th>

                            <th><a class="ahref " href="<?= Url::to(['/site/sum', 'sort' => 'level2']) ?>">Level
                                    2</th>

                            <th><a class="ahref " href="<?= Url::to(['/site/sum', 'sort' => 'level3']) ?>">Level
                                    3</th>

                            <th><a class="ahref "
                                   href="<?= Url::to(['/site/sum', 'sort' => 'defect_name']) ?>">Defektlar
                                    nomi</th>

                            <th style="text-align: center"><a class="ahref "
                                                              href="<?= Url::to(['/site/sum', 'sort' => 'count']) ?>">Defektlar
                                    soni</th>
                            <th><a href="<?= Url::to(['/site/sum', 'sort' => 'sum']) ?>">Umumiy summa</a></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?
                        foreach ($model as $key => $m):
                            ...
                            <tr>
                                ...
                                <td style="text-align: center"><?= $m['summ'] ?> sum</td>
                            </tr>
                        <? endforeach; ?>
                        </tbody>
                    </table>
