...
<section style="height: 100vh;" class=" card content">
    ...
    style=" display: flex;
          ...
          font-family: Georgia;"
    >
        <h5 class="sasasa" style="text-transform: uppercase;  ">Defektlar bo'yicha top 4 lik</h5>
    </div>
    <div class="row">
...
<script type="text/javascript">
    window.onload = function () {
        var chart1 = new CanvasJS.Chart("chartContainer1",
            {
                title: {
                    text: "Tsexlar bo'yicha jami summa "+numeral(<?=$sum?>).format('0,0')
                },
                axisY:{
                    labelFontSize: 5
                },
                        ...
                        dataPoints: [
                            {
                                ...
                                indexLabel: "<?=$shopsum_array[0]['name']?> sum:<?=($shopsum_array[0]['summ'] == null) ? 0 : number_format($shopsum_array[0]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[1]['count'] == null) ? 0 : $shopsum_array[1]['count']?>,
                                indexLabel: "<?=$shopsum_array[1]['name']?> sum:<?=($shopsum_array[1]['summ'] == null) ? 0 : number_format($shopsum_array[1]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[2]['count'] == null) ? 0 : $shopsum_array[2]['count']?>,
                                indexLabel: "<?=$shopsum_array[2]['name']?> sum:<?=($shopsum_array[2]['summ'] == null) ? 0 : number_format($shopsum_array[2]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[3]['count'] == null) ? 0 : $shopsum_array[3]['count']?>,
                                indexLabel: "<?=$shopsum_array[3]['name']?> sum:<?=($shopsum_array[3]['summ'] == null) ? 0 : number_format($shopsum_array[3]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[4]['count'] == null) ? 0 : $shopsum_array[4]['count']?>,
                                indexLabel: "<?=$shopsum_array[4]['name']?> sum:<?=($shopsum_array[4]['summ'] == null) ? 0 : number_format($shopsum_array[4]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[5]['count'] == null) ? 0 : $shopsum_array[5]['count']?>,
                                indexLabel: "<?=$shopsum_array[5]['name']?> sum:<?=($shopsum_array[5]['summ'] == null) ? 0 : number_format($shopsum_array[5]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[6]['count'] == null) ? 0 : $shopsum_array[6]['count']?>,
                                indexLabel: "<?=$shopsum_array[6]['name']?> sum:<?=($shopsum_array[6]['summ'] == null) ? 0 : number_format($shopsum_array[6]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[7]['count'] == null) ? 0 : $shopsum_array[7]['count']?>,
                                indexLabel: "<?=$shopsum_array[7]['name']?> sum:<?=($shopsum_array[7]['summ'] == null) ? 0 : number_format($shopsum_array[7]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[8]['count'] == null) ? 0 : $shopsum_array[8]['count']?>,
                                indexLabel: "<?=$shopsum_array[8]['name']?> sum:<?=($shopsum_array[8]['summ'] == null) ? 0 : number_format($shopsum_array[8]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[9]['count'] == null) ? 0 : $shopsum_array[9]['count']?>,
                                indexLabel: "<?=$shopsum_array[9]['name']?> sum:<?=($shopsum_array[9]['summ'] == null) ? 0 : number_format($shopsum_array[9]['summ'],0," "," ")?>"
                            },
                            {
                                y: <?=($shopsum_array[10]['count'] == null) ? 0 : $shopsum_array[10]['count']?>,
                                indexLabel: "<?=$shopsum_array[10]['name']?> sum:<?=($shopsum_array[10]['summ'] == null) ? 0 : number_format($shopsum_array[10]['summ'],0," "," ")?>"
                            },
                        ]
                    }
                ]
        ...
        var chart = new CanvasJS.Chart("chartContainer",
            {
                title: {
                    text: "Tsexlar bo'yicha jami defektlar soni (2021.02 oydan)"
                },
                axisY:{
                    labelFontSize: 5
                },
