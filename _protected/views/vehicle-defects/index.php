...
$session->set('searchModel', $searchModel);
?>
...
//                    return Html::a(($data->status == 1) ? "ochiq" : "yopiq", [Yii::$app->controller->id . '/update_shop', 'id' => $data->id], ['class' => ' s_modal']);
                    return ($data->status == 2) ? "yopiq" : (((Yii::$app->user->identity->role == 'controller') || (Yii::$app->user->identity->role == 'admin') ) ?
            ...
            [
                ...
                'header' => 'Oraliq vaqt',
                'value' => function ($data) {
                    $time = (strtotime($data->close_status_date) - strtotime($data->created_at)) / 60;
                    return ($data->close_status_date) ? number_format($time,2,",",".") . ' minut' : '';
