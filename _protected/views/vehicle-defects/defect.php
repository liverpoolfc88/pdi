                        ...
                        <div style="margin-top: 15px;" class="alert alert-info" role="alert">
                            ...
                            <? foreach ($m as $item): ?>
                                <p>
                                    ...
                                    <? $model_name = Models::find()->where(['model_code'=>$item->model])->one(); ?>
                                    <span style="color: red"> &nbsp Model:</span><b id="model"><?= $item->model."(".$model_name->model_name.")" ?></b>
        ...
        $.post("/site/vehicles", {array}, function (response) {
            ...
            $(".change2").change(function () {
                ...
                $(document).on('click', '.update', (function (e) {
                    $.get("/update_def", {array: array}, function (respo) {
                        console.log(respo);
                    });
                    var id = $(this).attr('data-id');
                    window.location.href='update_def?id='+id;
                    // alert('sasa');
                    // var id = $(this).attr('data-id');
